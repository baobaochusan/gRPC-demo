...
public final class OrderQueryServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.grpc.api.proto.Buyer,
            com.grpc.api.proto.Order> getListOrdersMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "ListOrders",
            requestType = com.grpc.api.proto.Buyer.class,
            responseType = com.grpc.api.proto.Order.class,
            methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
    public static io.grpc.MethodDescriptor<com.grpc.api.proto.Buyer,
            com.grpc.api.proto.Order> getListOrdersMethod() {
        io.grpc.MethodDescriptor<com.grpc.api.proto.Buyer, com.grpc.api.proto.Order> getListOrdersMethod;
            ...
            synchronized (OrderQueryServiceGrpc.class) {
                if ((getListOrdersMethod = OrderQueryServiceGrpc.getListOrdersMethod) == null) {
                    OrderQueryServiceGrpc.getListOrdersMethod = getListOrdersMethod =
                            io.grpc.MethodDescriptor.<com.grpc.api.proto.Buyer, com.grpc.api.proto.Order>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
                                    .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListOrders"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.grpc.api.proto.Buyer.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.grpc.api.proto.Order.getDefaultInstance()))
    ...
    public interface AsyncService {
         ...
         *
         */
        default void listOrders(com.grpc.api.proto.Buyer request,
                                io.grpc.stub.StreamObserver<com.grpc.api.proto.Order> responseObserver) {
    ...
    public static final class OrderQueryServiceStub
         ...
         *
         */
        public void listOrders(com.grpc.api.proto.Buyer request,
                               io.grpc.stub.StreamObserver<com.grpc.api.proto.Order> responseObserver) {
    ...
    public static final class OrderQueryServiceBlockingStub
         ...
         *
         */
        public java.util.Iterator<com.grpc.api.proto.Order> listOrders(
                com.grpc.api.proto.Buyer request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_LIST_ORDERS:
                    serviceImpl.listOrders((com.grpc.api.proto.Buyer) request,
                            (io.grpc.stub.StreamObserver<com.grpc.api.proto.Order>) responseObserver);
                    break;
                default:
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncServerStreamingCall(
                                new MethodHandlers<
                                        com.grpc.api.proto.Buyer,
                                        com.grpc.api.proto.Order>(
    ...
    private static abstract class OrderQueryServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.grpc.api.proto.OrderProto.getDescriptor();
        }
